...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<google-api-client>.freeze, ["~> 0.10.1"])
      ...
      s.add_development_dependency(%q<geminabox-release>.freeze, ["~> 0.2.0"])
      ...
      s.add_dependency(%q<google-api-client>.freeze, ["~> 0.10.1"])
      ...
      s.add_dependency(%q<geminabox-release>.freeze, ["~> 0.2.0"])
